...
import { AlertController, IonContent, IonHeader, IonTitle, IonToolbar, IonButtons, IonButton, IonList, IonItemSliding, IonItem, IonLabel, IonItemOptions, IonIcon, ModalController } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonButtons, IonButton, IonIcon, IonList, IonItemSliding, IonItem, IonLabel, IonItemOptions]
})
